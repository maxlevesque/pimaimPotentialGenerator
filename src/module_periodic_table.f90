...
! *****************************************************************************
  TYPE element
     ...
     INTEGER :: number
     REAL (dp) :: amass ! average mass in formula units
     REAL (dp) :: mass ! mass of most abundant isotope in formula units
     REAL (dp) :: covalent_radius ! in Angstroms
     REAL (dp) :: vdw_radius ! in Angstroms
     INTEGER :: e_conv ( 0:3 )
     REAL (dp) :: heat_of_formation ! in kcal/mol
     REAL (dp) :: eht_param ( 0:3 ) ! in eV
     REAL (dp) :: gyrom_ratio ! in Mhz/Tesla
  ...
  REAL(dp), PARAMETER :: z=0.0_dp, z1=2.015940_dp, z2=2.015650_dp
